...
//         // const newCart = await manager.addCart();
//         // newUser.cart = newCart._id;  // Relacionar el carrito con el usuario
//         // await newUser.save();

//         // Crear un carrito asociado al usuario
//         const newCart = await manager.addCart();
//         newCart.user = newUser._id;  // Relacionar el carrito con el usuario
//         await newCart.save();  // Guardar el carrito con la referencia al usuario

//         newUser.cart = newCart._id;  // Relacionar el usuario con el carrito
//         await newUser.save();  // Guardar el usuario con el carrito relacionado
